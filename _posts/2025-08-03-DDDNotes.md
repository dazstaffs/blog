...
- Allows you to query a web service to get only the data you need by building a graph.
- A graph essentially is just an object.
...
## DDD Reading 2018 - How Microsoft(MS) Does Dev Ops

- TFS
- VSTS
- 3500 developers at Microsoft
