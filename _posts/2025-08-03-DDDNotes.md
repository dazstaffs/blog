...
DDD Reading or Developer Developer Developer Reading, for many years was my favourite event of the year. Hundreds of Software Engineers would flock to the Microsoft HQ at Reading (on a Saturday as well!) to listen to the best speakers talk on software engineering subjects. It was impossible for a software engineer to not walk away from the event without a renewed sense of curiosity and for me, it was also a time to catch-up with my friends from my days at Stericycle Expert Solutions. Sadly, DDD Reading did not survive the COVID shutdown, but other DDD events still live-on across the country each year but hopefully the notes I made can inspire you to attend an event for yourself.
...
7. Security
   ...
   - Google top 10 breaches of security and you'll see that over the top 10 breaches over 37 million records have been leaked.
...
- Stable, self-managing, cross purpose teams are key.
- Team stability was very important. No team changes for 12 months were the goal so MS did a sticky note exercise to create self-forming teams:
...
- Security Mindsets
  ...
  - "Free iPhone" phishing email was sent around MS. Too many people replied.
...
- Challenges
  ...
  - Not favourable for data centric systems but you can use service bus queueing to solve data centric problems.
