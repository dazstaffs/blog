...
2. Instrumentation:
   ...
   - Timers,
   - Latency,
   - SPLUNK will help you visualise this data.
   - Metrics.net is another good example that comes with a dashboard.
...
7. Security
   ...
   - 1 Penetration test before deployment is never enough.
